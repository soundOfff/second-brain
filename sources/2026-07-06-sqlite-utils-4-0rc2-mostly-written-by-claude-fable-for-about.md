---
id: 2026-07-06-sqlite-utils-4-0rc2-mostly-written-by-claude-fable-for-about
...
>
> db = Database("data.db") db.table("news").insert({"headline": "Dog wins award"}) # The new row is already saved - no commit() required
>
